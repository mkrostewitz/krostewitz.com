  ...
  const userContent = [
    {
      ...
      text: JSON.stringify({
        ...
        outputRules: [
          ...
          "Allowed contentHtml tags: p, br, strong, em, u, s, h2, h3, h4, ul, ol, li, blockquote, a, figure, img, code, pre, hr, table, tbody, thead, tfoot, tr, th, td, colgroup, col, div, span.",
          "Embedded images must use figure[data-content-image=\"true\"] with data-align=\"block|left|right|full\" and data-size=\"small|medium|large\", containing one img with src, alt, and optional title.",
